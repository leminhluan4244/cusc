                                    ...
                                    {{--<div class="card mb-0">--}}
                                        ...
                                        {{--<div class="card-content collapse mt-1 mb-1">--}}
                                                ...
                                                {{--<div class="col-md-5 col-12">--}}
                                                    {{--<ul>--}}
                                                        ...
                                                        {{--<div id="buttonControl{{$val_child->cc_id}}">--}}
                                                            {{--<a class="btn btn-dark btn-sm round px-2 box-shadow-3 white ml-2 mt-1" onclick="insertResultScores('{{$data['user']->id}}','{{$val_child->cc_id}}','{{$val_child['entity']['ec_id']}}')">--}}
                                            ...
                                            {{--<div class="tab-content px-1 pt-1">--}}
                                                {{--@include('pages.point.tab1')--}}
                                                {{--@include('pages.point.tab2')--}}
                                                {{--@include('pages.point.tab3')--}}
                                            {{--</div>--}}
                                        {{--</div>--}}
                                    {{--</div>--}}
                                {{--</div>--}}
...
{{--</div>--}}
{{--<script>--}}
    {{--function insertResultScores(u_id,cc_id,ec_id) {--}}
        {{--$.ajax({--}}
            {{--type: 'POST',--}}
            ...
            {{--success: function (res) {--}}
                ...
                {{--var htmlTable =--}}
                    {{--'<tr id="trScores'+chitiet.rp_id+'">'+--}}
                        ...
                        {{--'<td>'+--}}
                            {{--'<a onclick="updateResultScoresShow('+chitiet.rp_id+','+chitiet.u_id+','+chitiet.cc_id+','+chitiet.ec_id+')" class="mr-1 success"><i class="la la-edit"></i></a>'+--}}
                            {{--'<a onclick="deleteResultScores('+chitiet.rp_id+')" class="danger"><i class="la la-close "></i></a>'+--}}
                        {{--'</td>';--}}
                    {{--'</tr>';--}}
        ...
        {{--});--}}
    {{--}--}}
    {{--function insertResultScoresShow(u_id,cc_id,ec_id) {--}}
        {{--htmlInsert =--}}
            {{--'<a class="btn btn-dark btn-sm rocc_idund px-2 box-shadow-3 white ml-2 mt-1" onclick="insertResultScores('+u_id+','+cc_id+','+ec_id+')">'+--}}
                {{--'<span class="font-size-base">Lưu lại</span>'+--}}
            {{--'</a>';--}}
        ...
        {{--$("#note"+cc_id).val(null);--}}
    {{--}--}}
    {{--function updateResultScoresShow(rp_id,u_id,cc_id,ec_id) {--}}
        ...
        {{--$.ajax({--}}
            ...
            {{--success: function (res) {--}}
                {{--chitiet = res.data;--}}
                {{--htmlUpdate =--}}
                    {{--'<a class="btn btn-success btn-sm round px-2 box-shadow-3 white ml-2 mt-1" onclick="updateResultScores('+rp_id+','+u_id+','+cc_id+','+ec_id+')">'+--}}
                    {{--'<span class="font-size-base">Lưu lại</span>'+--}}
                    {{--'</a>'+--}}
                    {{--'<a class="btn btn-danger btn-sm round px-2 box-shadow-3 white ml-2 mt-1" onclick="insertResultScoresShow('+u_id+','+cc_id+','+ec_id+')">'+--}}
        ...
        {{--});--}}
    {{--}--}}
    {{--function updateResultScores(rp_id,u_id,cc_id,ec_id) {--}}
        {{--$.ajax({--}}
            {{--type: 'POST',--}}
            ...
            {{--success: function (res) {--}}
                ...
                {{--insertResultScoresShow(u_id,cc_id,ec_id);--}}
            {{--}--}}
        {{--});--}}
    {{--}--}}
    {{--function deleteResultScores(rp_id) {--}}
        {{--var url = '{{route('result/api/remove',['id'=> ':slug'])}}';--}}
        {{--url = url.replace(':slug', rp_id);--}}
        {{--$.ajax({--}}
            {{--type: 'GET',--}}
            {{--url: url,--}}
