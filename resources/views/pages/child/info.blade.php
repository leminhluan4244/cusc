<div class="modal fade" id="infoChildModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
     aria-hidden="true">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="card profile-card-with-cover mb-0">
                                        ...
                                        <div class="profile-card-with-cover-content text-center">
                                            <div class="card-body">
                                                <h6 class="card-subtitle text-muted font-weight-bold danger" id="teacher_id">Tên giáo viên</h6>
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="text-left mt-2">
                                        <a href="">
                                            <span class="ft-eye background-round bg-info white"></span>
                                        </a>
                                        <a id="ctrlUpdate" data-toggle="modal" data-dismiss="modal">
                                            <span class="ft-edit-2 background-round bg-success white"></span>
                                        </a>
                                        <a id="ctrlLogicDelete" data-toggle="modal" data-dismiss="modal" >
                                            <span class="ft-trash-2 background-round bg-warning white"></span>
                                        </a>
                                        <a id="ctrlPhysicalDelete" data-toggle="modal" data-dismiss="modal">
