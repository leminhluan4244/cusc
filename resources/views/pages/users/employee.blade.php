        ...
        <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="">Cán bộ</a>
                    </li>
                ...
                <div class="content-header-left col-12">
                    ...
                    @if(\App\Http\Controllers\RouteViewController::routeView('users/create'))
                        <div class=" float-md-right">
                            <button class="btn btn-info round  px-2 box-shadow-3" onclick="getEmployeeList()" id="add"
                                    type="button"><i class="ft-plus icon-left"></i><span>Thêm cán bộ</span></button>
                        </div>
                    @endif
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Danh sách cán bộ</h4>
                                                ...
                                                <td>
                                                    <div class="justify-content-center">
                                                        <div class="btn-group text-center">
                                                            ...
                                                            <div class="dropdown-menu arrow">
                                                                @if(\App\Http\Controllers\RouteViewController::routeView('users/change'))
                                                                    <button class="dropdown-item " type="button"
                                                                            onclick="UpdateUserGetRoles('{{$value->r_id}}','{{$value->id}}')">
                                                            ...
                                                            @if(\App\Http\Controllers\RouteViewController::routeView('users/assignment/{id}'))
                                                                <a class="btn btn-success btn-sm "
                                                                   href="{{route('users/assignment',['id' => $value->id])}}">
                                                                    <i class="ft-shield text-white"></i>
                                                                </a>
                                                            @endif
                                                        </div>
                                                    </div>
...
@section('modal')
    @if(\App\Http\Controllers\RouteViewController::routeView('users/create'))
        @include('pages.users.create_employee')
    @endif
    @if(\App\Http\Controllers\RouteViewController::routeView('users/change'))
        @include('pages.users.update_employee')
    @endif
    @if(\App\Http\Controllers\RouteViewController::routeView('users/api/search/{id}'))
