        ...
        <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="">Chờ cấp</a>
                    </li>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Danh sách tài khoản chờ cấp quyền</h4>
                                                ...
                                                <td>
                                                    <div class="align-self-center">
                                                        <div class="btn-group text-center">
                                                            ...
                                                            @endif
                                                            @if(\App\Http\Controllers\RouteViewController::routeView('users/reset/role'))
                                                                <button data-toggle="popover"
                                                                        data-content="Cập nhật"
                                                                        data-trigger="hover"
                                                                        data-placement="top"
                                                                        onclick="getResetRole('{{$value->id}}')"
...
@section('modal')
    @if(\App\Http\Controllers\RouteViewController::routeView('users/reset/role'))
        @include('pages.users.reset_role')
    @endif
    @if(\App\Http\Controllers\RouteViewController::routeView('users/api/search/{id}'))
